...
//-------------------------------------------------------------------------------------
void OGRETest::createScene(void)
{
...
//-------------------------------------------------------------------------------------
void OGRETest::createFrameListener(void)
{
...
//-------------------------------------------------------------------------------------
// OIS::KeyListener
bool OGRETest::keyPressed(const OIS::KeyEvent& evt)
{
    switch (evt.key)
    {
    case OIS::KC_ESCAPE: 
...
bool OGRETest::keyReleased(const OIS::KeyEvent& evt)
{
    switch (evt.key)
    {
    case OIS::KC_UP:
...
// OIS::MouseListener
bool OGRETest::mouseMoved( const OIS::MouseEvent& evt )
{
...
bool OGRETest::mousePressed( const OIS::MouseEvent& evt, OIS::MouseButtonID id )
{
...
bool OGRETest::mouseReleased( const OIS::MouseEvent& evt, OIS::MouseButtonID id ){return true;}
//-------------------------------------------------------------------------------------
